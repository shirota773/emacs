...
(defface bm-face
  '((((class grayscale)
    ...
    (((class color)
      (background light)) (:foreground "yellow" :background "dark slate blue"))
    (((class color)
      (background dark))  (:foreground "yellow" :background "dark slate blue")))
...
(defface bm-persistent-face
  '((((class grayscale)
    ...
    (((class grayscale)
      (background dark))  (:background "LightGray"))
    (((class color)
      (background light)) (:foreground "yellow" :background "DarkBlue"))
    (((class color)
      (background dark))  (:foreground "yellow" :background "DarkBlue")))
...
(defface bm-fringe-face
  '((((class grayscale)
    ...
    (((class grayscale)
      (background dark))  (:background "LightGray"))
    (((class color)
      (background light)) (:foreground "White" :background "dark slate blue"))
    (((class color)
      (background dark))  (:foreground "Black" :background "dark slate blue")))
...
If ANNOTATION is provided use this, and not prompt for input."
  ...
  (if (bm-bookmarkp bookmark)
    ...
    (if (called-interactively-p) (message "No bookmark at point"))))

...
(defconst navi2ch-board-misc-ident
  "$Id: navi2ch-board-misc.el,v 1.110.2.1 2008/08/26 14:08:25 nawota Exp $")
...
(defun navi2ch-bm-mark (&optional arg)
  (interactive "P")
  (navi2ch-bm-mark-subr t arg (called-interactively-p)))

(defun navi2ch-bm-unmark (&optional arg)
  (interactive "P")
  (navi2ch-bm-mark-subr nil arg (called-interactively-p)))
